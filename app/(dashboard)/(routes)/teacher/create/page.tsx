...
const CreatePage = () => {
    ...
    return ( 
        <div className="max-w-5xl mx-auto flex md:items-center md:justify-center h-full p-6">
          <div>
                <h1 className="text-2xl">Назовите страницу своего курса</h1>
                <p className="text-sm text-slate-600">
                Как бы вы хотели назвать свой курс? Не волнуйтесь, вы можете изменить позже
                </p>
                <Form {...form}>
                    <form
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormDescription>
                                        Чему вы научите на своем курсе?
                                    </FormDescription>
                                    <FormMessage />
                                </FormItem>
                            )}
